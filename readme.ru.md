...
Веб-приложение обрабатывает большие текстовые блоки, разбивая их на управляемые фрагменты и отправляя каждый из них в модель Google Gemini (Gemini Flash 2.0). Интерфейс позволяет вставлять текст вручную или загружать файлы с подсказками и содержимым, настраивать ограничение скорости запросов и получать итоговый ответ в одном объединённом файле.
